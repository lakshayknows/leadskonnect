...
| [docs/linkedin-automations.md](docs/linkedin-automations.md) | The 35 PhantomBuster LinkedIn automations: inputs, outputs and limits, as the reference spec for our own scrapers |
